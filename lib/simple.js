...
const { proto, delay, getContentType, areJidsSameUser, generateWAMessage, generateWAMessageFromContent, prepareWAMessageMedia } = require("@whiskeysockets/baileys")
 ...
 * Create By DitzOfc
 * Jangan Apus WM gua
 * Copas? taruh credit gua
 */
conn.sendMessageToNewsLetter = (jid, text, options = {}) => {
const messages = { 
extendedTextMessage: {
       text: text,
       ...options
...
conn.sendReplyFooter = async (jid, text = "", footer = "", quoted = null) => {
    try {
                ...
                message: {
                    ...
                    interactiveMessage: proto.Message.InteractiveMessage.create({
                        ...
                        nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({
                            ...
                            {
                                "name": "button",
                                "buttonParamsJson":"{\"display_text\":\"Info Owner\",\"id\":\".owner\"}"
                           }]
                    })
                })
            }
